        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        <span class="">Select restaurant image to upload:<i class=""></i></span>
                        <input type="file" name="imagefile" id="fileToUpload" required>
                    </div>
                    <hr>
                    <b>Verification By Pan Image:</b><br>
                    <div class="input-group">
                        <span class="">Select PAN card image to upload:<i class=""></i></span>
                        <input type="file" name="panimage" id="fileToUpload" required>
                    </div>
                    <hr>
